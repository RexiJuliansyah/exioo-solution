        ...
        <div class="col-sm-6 col-sm-offset-3" >
            <div class="text-center mt-50 mb-20">
                <h2 style="font-family:Open Sans; font-size: 32px; font-weight: 800;">
                    <span class="login-app red" style="color:#667add">Management System</span>
                </h2>
                <h6 class="txt-grey">© Test Project 01</h6>
            </div>
            <div class="panel panel-default card-view" style="box-shadow: 0 3px 9px rgb(0 0 0 / 50%);" >
                <div class="panel-body pa-0 ma-0">
                    <div class="row" >
                        <div class="hidden-sm hidden-xs col-md-6 pr-0" style="padding-bottom: 15px;">
                            <img src="{{ asset('admin') }}/dist/img/chair3.jpg " class="img-responsive" alt="Logo">
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="panel panel-default card-view pa-10" >
                                <div class="panel-body ma-0 pa-0">
                                    <div class="text-center">
                                        <h6 class="nonecase-font txt-dark mb-10 mt-10" >Masuk</h6>
                                    </div>
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group text-right mt-20 mb-0">
                                            <button type="submit" class="btn btn-primary btn-xs btn-icon left-icon" >
                ...
                <div class="panel-footer" style="background-color:#667add">
                    <p class="text-right mt-0" style="font-size: 10px; font-weight: normal;"><small class="txt-light "> &copy; 2024</small></p>
                </div>
            </div>
        </div>
    </div>
