...
<div class="row">
    <div class="panel panel-primary card-view mt-10">
        <div class="panel-heading pt-10 pb-10">
            <div class="pull-left">
                <h6 class="panel-title txt-light">Pengaturan / Hak Akses</h6>
            </div>
            <div class="clearfix"></div>
        </div>

        <div class="panel-body">
            <div class="panel panel-primary card-view ma-0 pt-0 pb-10">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="button-list">
                            ...
                            <div class="pull-right">
                                <button type="button" class="btn btn-primary btn-sm left-icon pr-10 pl-10" id="btn_permission" disabled>Perizinan Hak Akses</button>
                            </div>
                        </div>
                    </div>
                </div>
